  ...
  return (
    ...
    >
      <span className="capitalize md:w-1/3 lg:w-1/2 flex items-center justify-center py-5 px-2 relative">
        <h1
          className="flex gap-3 items-center justify-center cursor-pointer text-xl lg:text-3xl font-bold bg-clip-text text-transparent uppercase"
          onClick={() => navigate("/")}
        >          
          <img
            src="myimg.png"
